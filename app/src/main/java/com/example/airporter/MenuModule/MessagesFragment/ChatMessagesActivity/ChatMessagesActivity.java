package com.example.airporter.MenuModule.MessagesFragment.ChatMessagesActivity;
...
import com.example.airporter.MenuModule.MessagesFragmentModule.ChatMessagesModule.ChatMessagesMvpContract;
import com.example.airporter.MenuModule.MessagesFragmentModule.ChatMessagesModule.ChatMessagesPresenter;
import com.example.airporter.MenuModule.MessagesFragmentModule.ChatMessagesModule.ChatMessagesRecyclerViewAdapter;
...
public class ChatMessagesActivity extends AppCompatActivity implements ChatMessagesMvpContract.ChatMessagesView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new ChatMessagesPresenter(this, ApiRequestManager.getInstance(), userId);
    ...
    public void onChatMessageUploaded(ChatMessage chatMessage) {
        ...
        mPresenter.sendChatMessage(fcmToken, senderName, chatMessage.getChatMessage(), message);
    }
