...
public class InTransitOrdersRecyclerViewAdapter extends RecyclerView.Adapter<InTransitOrdersRecyclerViewAdapter.MyViewHolder> {
    private ArrayList<Order> inTransitOrderList;
    private InTransitOrderFragment containerFragment;

    public InTransitOrdersRecyclerViewAdapter(ArrayList<Order> inTransitOrderList, InTransitOrderFragment containerFragment) {
        this.inTransitOrderList = inTransitOrderList;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_in_transit_orders, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Order order = inTransitOrderList.get(position);
    ...
    public int getItemCount() {
        return inTransitOrderList.size();
    }
